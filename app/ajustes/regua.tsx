 ...
 *
 * **Mora em Ajustes, e não em Audiência.** Régua é coisa que se define uma vez e se
 * revisa por temporada; Audiência é coisa que se olha todo dia. Misturar as duas fazia a
 * tela do dia a dia abrir num formulário de configuração — e formulário de configuração
 * ao lado de número de audiência confunde quem só queria saber quantos estão no ar.
 *
 ...
 */
export function ReguaDeConexao() {
